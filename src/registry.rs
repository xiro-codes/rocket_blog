use crate::services::{AuthService, BlogService, CommentService, OpenAIService, OllamaService, AIProviderService, ReactionService, SettingsService, TagService, CoordinatorService, YoutubeDownloadService};
...
impl ServiceRegistry {
    ...
    pub fn attach_all_services(rocket: Rocket<Build>) -> Rocket<Build> {
        ...
        log::debug!("Attaching services: Auth, Blog, Comment, OpenAI, Ollama, AIProvider, Reaction, Settings, Tag, Coordinator, YouTube");
